    ...
    <>
      ...
      >
        ...
        <p className="text-secondary text-[17px] lg:ml-12 lg:mt-0 mt-8">
          ...
          Additionally, I have experience in mobile app development and AI
          integration, crafting intelligent systems that deliver exceptional
          user experiences. Driven by curiosity and a commitment to continuous
          growth, I’m eager to tackle challenging projects and expand my skill
          set. If you’re looking for a developer with a dynamic skill set to
