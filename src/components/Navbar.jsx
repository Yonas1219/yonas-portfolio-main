    ...
    >
      <div className="flex items-center justify-between w-full mx-auto max-w-7xl">
        ...
        <ul className="flex-row items-center hidden gap-10 list-none sm:flex">
          ...
          <a
            href={`#contact`}
            className="text-black flex items-center gap-x-2 bg-[#a2a9ff] text-[14px] sm:text-[18px] px-4 sm:px-6 py-2 rounded-md"
          >
            <Icon icon="ic:outline-email" className="text-lg sm:text-xl" />
            Contact
          </a>
        </ul>
